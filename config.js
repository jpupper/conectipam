// CONECTIPAM - Archivo de configuración global
...
const CONFIG = {
    ...
    // SECUENCIAS
    sequences: {
        nodeSize: 20,                 // Tamaño de los nodos de secuencia
        nodeActiveColor: [0, 255, 0], // Color RGB de nodos activos
        nodeInactiveColor: [150, 150, 150], // Color RGB de nodos inactivos
        nodeCompletedColor: [0, 100, 255], // Color RGB de nodos completados
        connectionThickness: 3,       // Grosor de las conexiones entre nodos
        activationDistance: 50,       // Distancia para activar un nodo
        completionTime: 1000,         // Tiempo en ms para completar un nodo
    },
    ...
    // FONDO DINÁMICO
    background: {
        color: [0, 0, 20],            // Color RGB del fondo
        grid: {
            ...
            colors: {                 // Colores de los puntos (modo HSB)
                hueRange: [200, 250], // Rango de tonalidad
                satRange: [50, 100],  // Rango de saturación
                briRange: [10, 40]    // Rango de brillo
            },
        ...
        ripples: {
            ...
            color: [100, 150, 255]    // Color base de las ondas
        }
    },
